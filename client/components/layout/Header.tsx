...
const Header = () => {
    ...
    return (
        <header className="bg-[#0f1941] h-[32px] py-0.5 text-white fixed top-0 left-0 right-0 z-50 flex justify-center items-center px-2 text-center text-xs md:text-sm">
