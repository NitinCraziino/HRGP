...
const PrivateNavBar = () => {
  ...
  const [openDropdown, setOpenDropdown] = useState<
    "ATS" | "EMS" | "CALENDAR" | "HISTORY" | "TOOLS" | null
  >(null);
  ...
  return (
    <>
              ...
              <div className="flex items-center">
                <nav className="hidden header:flex space-x-4 items-center mx-auto text-base sm:text-lg justify-center mr-10">
                  ...
                  <Link
                    href="/calendar"
                    prefetch={false}
                    className="flex items-center px-2text-xs sm:text-sm font-medium cursor-pointer hover:bg-[#1a2847] rounded-md"
                  >
                ...
                <div className="flex items-center pr-4 sm:pr-2">
                  <Link href={"/user-profile"} className="flex items-center mr-4 cursor-pointer">
                    <div className="flex items-center space-x-2 text-xs sm:text-sm">
                      ...
                      <span className="text-xs sm:text-sm font-medium cursor-pointer">
                        Minimal Access
                      </span>
                    </div>
                  </Link>
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <ActionIcon link="/emails" icon={<Mail className="h-5 w-5" />} />
                    <ActionIcon
                      link="/chat"
                      icon={
                        <Image src="/assets/icons/chat.svg" alt="Chat" width={20} height={20} />
                      }
                    />
                    <button
                    ...
                    >
                      <Image src="/assets/icons/leave.svg" alt="Leave" width={20} height={20} />
                    </button>
                  </div>
                </div>
              </div>
      ...
      <ConfirmLogoutDialog isOpen={isConfirmLogoutOpen} onOpenChange={setIsConfirmLogoutOpen} />
    </>
  );
};
