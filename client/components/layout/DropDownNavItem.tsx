...
const DropdownNavItem = ({ icon, label, isOpen, setIsOpen, items, onClose }: DropdownNavItemProps) => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                <i className={`fas fa-angle-down ml-2 transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`} />
            </div>
