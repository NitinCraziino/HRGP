...
const ForgetPasswordForm = () => {
  ...
  const { mutate: resendVerificationCode, isPending: isResendVerificationCodeLoading } =
    useResendVerificationCode();
  const { mutate: verifyVerificationCode, isPending: isVerifyVerificationCodeLoading } =
