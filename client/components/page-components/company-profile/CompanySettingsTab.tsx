      ...
      <Card className="border rounded-md shadow-sm p-6">
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="flex items-center space-x-2">
            <Checkbox id="automated-job-code" defaultChecked {...register("automatedJobCode")} />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox id="send-twilio" {...register("sendTwilioOptInEmail")} />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox id="recruit-for-customers" {...register("recruitForCustomers")} />
          ...
          <div className="flex justify-end">
            <Button className="bg-indigo-600 text-white hover:bg-indigo-700">Update</Button>
          </div>
        </form>
      </Card>
    </TabsContent>
